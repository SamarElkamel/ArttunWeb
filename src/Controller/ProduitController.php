    ...
    public function index(Request $request, ProduitRepository $produitRepository): Response
{
    ...
    return $this->render('produit/index.html.twig', [
        ...
        #[Route('/stat', name: 'app_produit_stat', methods: ['GET'])]
    ...
    public function indexfront(CategorieProduitRepository $categorieProduitRepository,ProduitRepository $produitRepository): Response
    {
...
#[Route('/export/pdf', name: 'app_produit_export_pdf', methods: ['GET', 'POST'])]
